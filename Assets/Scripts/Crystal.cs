...
namespace Match3Prototype
{
    ...
    public class Crystal : MonoBehaviour
    {
        ...
        [SerializeField] private float sparkleFadeTime = 0.2f; // Animation time in seconds
        ...
        public void CheckNeighbor(List<Crystal> list, Vector2 direction)
        {
            ...
            if (hitedCrystal != null && hitedCrystal.CrystalColor == this.CrystalColor)
            {
                hitedCrystal.CheckNeighbor(list, direction);
                list.Add(this);
            }
